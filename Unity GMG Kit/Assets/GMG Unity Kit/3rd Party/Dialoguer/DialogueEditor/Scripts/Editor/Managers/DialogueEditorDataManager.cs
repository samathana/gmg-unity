	...
	public class DialogueEditorDataManager{
		...
		public static void save(string filename = "")
		{
			...
			if(!System.IO.Directory.Exists(resourcesFolderPath)){
				string temp = DialogueEditorFileStatics.ASSETS_FOLDER_PATH+"/"+@DialogueEditorFileStatics.OUTPUT_FOLDER_PATH;
				AssetDatabase.CreateFolder(@temp, DialogueEditorFileStatics.OUTPUT_RESOURCES_FOLDER_PATH);
			...
			string filePath = Application.dataPath + "/" + DialogueEditorFileStatics.ASSETS_FOLDER_PATH2 +  DialogueEditorFileStatics.PATH + DialogueEditorFileStatics.DIALOGUE_DATA_FILENAME_SO;
