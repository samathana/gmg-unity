...
namespace DialoguerEditor{
	public class DialogueEditorGUI : MonoBehaviour {
			...
			get{
				if(__gui == null){
					if(EditorGUIUtility.isProSkin){
						__gui = AssetDatabase.LoadAssetAtPath(@"Assets/GMG Unity Kit/3rd Party/Dialoguer/DialogueEditor/Skins/dialogueEditorSkinDark.guiskin", typeof(GUISkin)) as GUISkin;
					}else{
						__gui = AssetDatabase.LoadAssetAtPath(@"Assets/GMG Unity Kit/3rd Party/Dialoguer/DialogueEditor/Skins/dialogueEditorSkinLight.guiskin", typeof(GUISkin)) as GUISkin;
					}
				}
				return __gui;
			}
		...
		public static GUISkin editorGui{
			get{
				if(__editorGui == null){
					__editorGui = Resources.LoadAssetAtPath("Assets/GMG Unity Kit/3rd Party/Dialoguer/DialogueEditor/Skins/EditorSkin.guiskin", typeof(GUISkin)) as GUISkin;
				}
				return __editorGui;
			}
		}
		...
		public static Texture2D bezierTexture{
			get{
				if(__bezierTexture == null){
					__bezierTexture = AssetDatabase.LoadAssetAtPath(@"Assets/GMG Unity Kit/3rd Party/Dialoguer/DialogueEditor/Textures/GUI/Dark/bezier_texture.png", typeof(Texture2D)) as Texture2D;
				}
		...
		public static Texture2D scrollboxBgTexture{
			get{
				if(__scrollboxBgTexture == null){
					__scrollboxBgTexture = AssetDatabase.LoadAssetAtPath(@"Assets/GMG Unity Kit/3rd Party/Dialoguer/DialogueEditor/Textures/GUI/Dark/scrollbox_bg.png", typeof(Texture2D)) as Texture2D;
		...
		public static string toolbarIconPath{
			get{
				if(__toolbarIconPath == null){
					__toolbarIconPath = @"Assets/GMG Unity Kit/3rd Party/Dialoguer/DialogueEditor/Textures/GUI/";
